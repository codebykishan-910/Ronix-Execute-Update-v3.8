...
[![Stars](https://img.shields.io/github/stars/Ronix-Execute-Update-v3.8?style=flat-square)](https://github.com)
...
git clone https://github.com/Ronix-Execute-Update-v3.8.git
cd Ronix-Execute-Update-v3.8
